...
class NeuralMethod:
    def __init__(self, english_doc_path, russian_doc_path) -> None:
        self.data = None
        self.prepare_dataset(english_doc_path, russian_doc_path)
        self.init_model()
    ...
    def init_model(self):
        ...
        for l in lang:
            lang_trim = self.data[self.data['lang'] == l].sample(200, replace=True, random_state=100)
        ...
        self.encoder.fit(['English', 'Russian'])
    ...
    def prepare_dataset(self, english_doc_path, russian_doc_path):
